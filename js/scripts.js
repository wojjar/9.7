...
//============ Zmienne wskazujące na elemnty gry
...
//============ Uruchamiana po wciśnięciu przycisku "NewGame"
...
function newGame() {
    ...
    if (player.name) {
        ...
        setGamePoints(); // This function has  been created 
    }
}
...
///============ Umieszczanie wyboru na stronie
